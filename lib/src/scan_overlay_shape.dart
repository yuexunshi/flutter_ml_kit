...
class ScannerOverlayShape extends ShapeBorder {
  ...
  void paint(Canvas canvas, Rect rect, {TextDirection? textDirection}) {
    ...
    final borderWidthSize = width *0.4;
    final height = rect.height;
    final borderHeightSize = height*0.24;
    final borderSize = Size(borderWidthSize / 2, borderHeightSize);
    //(86.4, 302.4)
    var paint = Paint()
      ..color = overlayColor
    ...
    canvas
      ..drawPath(
          Path()
            ...
            ..lineTo(realReact.right, realReact.top + lineLength),
          paint)
      ..drawPath(
          Path()
            ..moveTo(realReact.right, realReact.top)
            ..lineTo(realReact.right - lineLength, realReact.top),
          paint)
      ..drawPoints(
        PointMode.points,
      ...
      ..drawPath(
          Path()
            ...
            ..lineTo(realReact.left, realReact.top + lineLength),
          paint)
      ..drawPath(
          Path()
            ..moveTo(realReact.left, realReact.top)
            ..lineTo(realReact.left + lineLength, realReact.top),
          paint)
      ..drawPoints(
        PointMode.points,
      ...
      ..drawPath(
          Path()
            ...
            ..lineTo(realReact.right, realReact.bottom - lineLength),
          paint)
      ..drawPath(
          Path()
            ..moveTo(realReact.right, realReact.bottom)
            ..lineTo(realReact.right - lineLength, realReact.bottom),
          paint)
      ..drawPoints(
        PointMode.points,
      ...
      ..drawPath(
          Path()
            ...
            ..lineTo(realReact.left, realReact.bottom - lineLength),
          paint)
      ..drawPath(
          Path()
            ..moveTo(realReact.left, realReact.bottom)
            ..lineTo(realReact.left + lineLength, realReact.bottom),
          paint)
      ..drawPoints(
        PointMode.points,
